    ...
    static async getPromoCodeById(req, res, next) {
        try {
            ...
            if (!promoCode) {
                return res
                    .status(404)
                    .json({ message: "Promo code not found" });
            }
    ...
    static async validatePromoCode(req, res, next) {
        try {
            ...
            if (!code) {
                return res
                    .status(400)
                    .json({ message: "Promo code is required" });
            }
        ...
        try {
            ...
            if (!ticketName || !fullName) {
                return res.status(400).json({
                    message: "Both ticket name and full name are required",
                });
            }
            ...
            // Update hasAttended status to true
            await orderDetail.update({ hasAttended: true });
